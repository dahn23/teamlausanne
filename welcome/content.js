...
export const SEEDS = [
  ...
  { n: 5, nom: "Lorenzo Carboni", pays: "Italie", drapeau: "it", atp: 481,
    bio: "Jeune joueur italien en progression sur le circuit ITF." },
  { n: 6, nom: "Luca Staeheli", pays: "Suisse", drapeau: "ch", atp: 521,
    bio: "Espoir suisse engagé sur le circuit professionnel." },
  { n: 7, nom: "Dimitris Sakellaridis", pays: "Grèce", drapeau: "gr", atp: 556,
    bio: "Né le 30 avril 2006. Il a été numéro 1 mondial junior en octobre 2024. Ses deux frères, Michalis et Stefanos, sont également joueurs de tennis." },
...
export const CLUB = {
  ...
  avantages: [
    ...
    { icon: "racket", titre: "Des cours pour tous les âges",
      texte: "De l'initiation adulte au perfectionnement, en groupe ou en cours privé, avec des coachs diplômés présents toute la semaine." },
    { icon: "users", titre: "Un club, pas seulement des courts",
      texte: "Soirées, tournois maison, sorties : l'adhésion ouvre la porte à une vie de club, pas juste à un créneau de réservation." },
