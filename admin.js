...
async function enableMailNotifs() {
  ...
  try {
    ...
    try { await reg.showNotification("Notifications activées ✓", { body: "Tu recevras les nouveaux mails ici.", icon: "assets/pwa/admin-icon-192.png", badge: "assets/pwa/admin-badge.png", tag: "mail" }); } catch (_) {}
